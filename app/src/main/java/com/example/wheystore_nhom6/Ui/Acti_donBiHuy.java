...
public class Acti_donBiHuy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acti_don_bi_huy);

        _list = new ArrayList<>();
        adapter = new choXacNhan_Adapter(_list,Acti_donBiHuy.this);
        recyclerView = findViewById(R.id.recyclerView_Acti_donBiHuy);
        LinearLayoutManager manager = new LinearLayoutManager(Acti_donBiHuy.this,RecyclerView.VERTICAL,false);
    ...
    private void READ() {
        firebaseFirestore.collection("HoaDon").addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                hoaDon_dao.read_choXacNhan(_list,adapter,"Đơn Hàng Bị Hủy");
            }
        });
    }
}